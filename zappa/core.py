        ...
        for root, dirs, files in os.walk(temp_project_path):
            ...
            for filename in files:
                ...
                if filename[-4:] == '.pyc':
                    ...
                    if self.runtime == "python3.6":
                        if magic_int not in [3360, 3361, 3370, 3371, 3372, 3373, 3375, 3376, 3377, 3378, 3379]:
                            raise EnvironmentError(
                                "File {} has an invalid magic number for this python runtime: {}".format(
                                    filename, magic_int
                                )
                            )

                    else:  # 2.7
                        if magic_int not in [62171, 62181, 62191, 62201, 62211]:
                            raise EnvironmentError(
                                "File {} has an invalid magic number for this python runtime: {}".format(
                                    filename, magic_int
                                )
